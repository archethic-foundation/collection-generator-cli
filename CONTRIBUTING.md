...
* [Github Discussions](https://github.com/archethic-foundation/collection-generator-cli/discussions)
...
This section guides you through submitting a bug report for Archethic Collection Generator CLI. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behavior :computer: :computer:, and find related reports :mag_right:.
...
* **Check the [discussions](https://github.com/archethic-foundation/collection-generator-cli/discussions)** for a list of common questions and problems.
* **Check the [issue list](https://github.com/archethic-foundation/collection-generator-cli/issues)** if it has been already opened.
...
This section guides you through submitting an enhancement suggestion for Archethic Collection Generator CLI, including completely new features and minor improvements to existing functionality. Following these guidelines helps maintainers and the community understand your suggestion :pencil: and find related suggestions :mag_right:.
...
- Maintain Archethic Collection Generator CLI's quality
